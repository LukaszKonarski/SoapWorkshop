...
//    public void useShipment(Integer shipmentId){
//        Shipment chosenShipment = shipmentRepository.findOne(shipmentId);
//        BigDecimal shipmentCost = chosenShipment.getCost();
//        Product usedShipment = new Product();
//        usedShipment.setName(chosenShipment.getName());
//        usedShipment.setQuantity(1);
//        usedShipment.setPrice(shipmentCost);
//        List<Product> cart = shoppingCart.getCartContents();
//        cart.add(usedShipment);
//
//    }
    ...
    public BigDecimal getCartTotal() {
        ...
        cartTotal = cartTotal.add(new BigDecimal(15));
        return cartTotal;
    }
