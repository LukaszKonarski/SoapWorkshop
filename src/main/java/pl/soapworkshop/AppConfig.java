...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "pl.soapworkshop")
@EnableTransactionManagement

@EnableJpaRepositories(
        basePackages = {"pl.soapworkshop.repository"}
)
public class AppConfig extends WebMvcConfigurerAdapter {
    ...
    public LocalEntityManagerFactoryBean entityManagerFactory() {
        ...
        emfb.setPersistenceUnitName("SoapShopPersistenceUnit");
        return emfb;
    }
