...
<div class="container-fluid">
    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <%--<ul class="dropdown-menu">--%>
            <%--<c:forEach items="${typeOfShipment}" var="ship">--%>
            <%--<li><a href="<c:url value="//store/shoppingCart/${ship.id}"/>">${ship.name}</a></li>--%>
            <%--</c:forEach>--%>
            <%--</ul>--%>
            <%--</div>--%>
        ...
        <form:form method="post" action="/store/orderCheckout" modelAttribute="address">
            <h5>Telefon:</h5>
            <input type="number" name="telephoneNo"/>
            <h5>Email:</h5>
            <input type="email" name="email"/>
            <h5>Ulica, nr domu/mieszkania:</h5>
            <input type="text" name="street"/>
            <h5>Maisto, kod pocztowy</h5>
            <input type="text" name="city" />
            <input type="submit" class="btn btn-default" value="Potwierdź zamówienie">
        </form:form>
